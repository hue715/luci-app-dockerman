...
_docker.new = function()
	...
	_docker.options = {
		host = (remote == "true") and (uci:get("dockerd", "dockerman", "remote_host")) or nil,
		port = (remote == "true") and (uci:get("dockerd", "dockerman", "remote_port")) or nil,
		socket_path = (remote ~= "true") and (uci:get("dockerd", "dockerman", "socket_path") or "/var/run/docker.sock") or nil,
